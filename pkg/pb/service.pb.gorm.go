...
It is generated from these files:
	github.com/EvgenyMilev/example-app/pkg/pb/service.proto
...
func DefaultReadBook(ctx context.Context, in *Book, db *gorm1.DB, fs *query1.FieldSelection) (*Book, error) {
	if in == nil {
		return nil, errors1.NilArgumentError
	}
	ormObj, err := in.ToORM(ctx)
	...
	if db, err = gorm2.ApplyFieldSelection(ctx, db, fs, &BookORM{}); err != nil {
		return nil, err
	}
...
func DefaultPatchBook(ctx context.Context, in *Book, updateMask *field_mask1.FieldMask, db *gorm1.DB) (*Book, error) {
	...
	pbReadRes, err := DefaultReadBook(ctx, &Book{Id: in.GetId()}, db, nil)
	if err != nil {
		return nil, err
	}
	pbObj = *pbReadRes
...
type ExampleAppDefaultServer struct {
}

// List ...
func (m *ExampleAppDefaultServer) List(ctx context.Context, in *ListBookRequest) (*ListBookResponse, error) {
	...
	if custom, ok := interface{}(in).(ExampleAppBookWithBeforeList); ok {
		var err error
	...
	if custom, ok := interface{}(in).(ExampleAppBookWithAfterList); ok {
		var err error
...
// ExampleAppBookWithBeforeList called before DefaultListBook in the default List handler
type ExampleAppBookWithBeforeList interface {
	BeforeList(context.Context, *gorm1.DB) (*gorm1.DB, error)
}

// ExampleAppBookWithAfterList called before DefaultListBook in the default List handler
type ExampleAppBookWithAfterList interface {
	AfterList(context.Context, *ListBookResponse, *gorm1.DB) error
}

// Read ...
func (m *ExampleAppDefaultServer) Read(ctx context.Context, in *ReadBookRequest) (*ReadBookResponse, error) {
	txn, ok := gorm2.FromContext(ctx)
	if !ok {
		return nil, errors1.NoTransactionError
	}
	...
	if custom, ok := interface{}(in).(ExampleAppBookWithBeforeRead); ok {
		var err error
		if db, err = custom.BeforeRead(ctx, db); err != nil {
			return nil, err
		}
	}
	res, err := DefaultReadBook(ctx, &Book{Id: in.GetId()}, db, in.Fields)
	if err != nil {
		return nil, err
	}
	out := &ReadBookResponse{Result: res}
	if custom, ok := interface{}(in).(ExampleAppBookWithAfterRead); ok {
		var err error
...
// ExampleAppBookWithBeforeRead called before DefaultReadBook in the default Read handler
type ExampleAppBookWithBeforeRead interface {
	BeforeRead(context.Context, *gorm1.DB) (*gorm1.DB, error)
}

// ExampleAppBookWithAfterRead called before DefaultReadBook in the default Read handler
type ExampleAppBookWithAfterRead interface {
	AfterRead(context.Context, *ReadBookResponse, *gorm1.DB) error
}

// Create ...
func (m *ExampleAppDefaultServer) Create(ctx context.Context, in *CreateBookRequest) (*CreateBookResponse, error) {
	out := &CreateBookResponse{}
	return out, nil
}

// Update ...
func (m *ExampleAppDefaultServer) Update(ctx context.Context, in *UpdateBookRequest) (*UpdateBookResponse, error) {
	var err error
	var res *Book
	txn, ok := gorm2.FromContext(ctx)
	if !ok {
	...
	if custom, ok := interface{}(in).(ExampleAppBookWithBeforeUpdate); ok {
		var err error
	...
	if in.GetFields() == nil {
		...
		res, err = DefaultPatchBook(ctx, in.GetPayload(), in.GetFields(), db)
	}
	if err != nil {
		return nil, err
	}
	out := &UpdateBookResponse{Result: res}
	if custom, ok := interface{}(in).(ExampleAppBookWithAfterUpdate); ok {
		var err error
...
// ExampleAppBookWithBeforeUpdate called before DefaultUpdateBook in the default Update handler
type ExampleAppBookWithBeforeUpdate interface {
	BeforeUpdate(context.Context, *gorm1.DB) (*gorm1.DB, error)
}

// ExampleAppBookWithAfterUpdate called before DefaultUpdateBook in the default Update handler
type ExampleAppBookWithAfterUpdate interface {
	AfterUpdate(context.Context, *UpdateBookResponse, *gorm1.DB) error
}

// Delete ...
func (m *ExampleAppDefaultServer) Delete(ctx context.Context, in *DeleteBookRequest) (*DeleteBookResponse, error) {
	txn, ok := gorm2.FromContext(ctx)
	if !ok {
		return nil, errors1.NoTransactionError
	}
	...
	if custom, ok := interface{}(in).(ExampleAppBookWithBeforeDelete); ok {
		var err error
	...
	if custom, ok := interface{}(in).(ExampleAppBookWithAfterDelete); ok {
		var err error
...
// ExampleAppBookWithBeforeDelete called before DefaultDeleteBook in the default Delete handler
type ExampleAppBookWithBeforeDelete interface {
	BeforeDelete(context.Context, *gorm1.DB) (*gorm1.DB, error)
}

// ExampleAppBookWithAfterDelete called before DefaultDeleteBook in the default Delete handler
type ExampleAppBookWithAfterDelete interface {
	AfterDelete(context.Context, *DeleteBookResponse, *gorm1.DB) error
}

// GetVersion ...
func (m *ExampleAppDefaultServer) GetVersion(ctx context.Context, in *google_protobuf.Empty) (*VersionResponse, error) {
	out := &VersionResponse{}
	return out, nil
}
